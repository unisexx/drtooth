						...
						<tr>
							...
							<td class="td-actions">
								<div class="hidden-phone visible-desktop action-buttons">
									<a class="green" href="hilights/admin/hilights/form/<?php echo $row->id ?>">
										<i class="icon-pencil bigger-130"></i>
									</a>

									<a class="red" href="hilights/admin/hilights/delete/<?php echo $row->id?>" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">
								...
								<div class="hidden-desktop visible-phone">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
											...
											<li>
												<a href="hilights/admin/hilights/delete/<?=$row->id?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">
													<span class="red">
