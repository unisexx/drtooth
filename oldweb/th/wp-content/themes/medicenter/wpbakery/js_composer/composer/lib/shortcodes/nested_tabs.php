...
class WPBakeryShortCode_VC_Nested_Tabs extends WPBakeryShortCode {
    ...
    public function getTabTemplate() {
        return '<div class="wpb_nested_template">'.do_shortcode('[vc_nested_tab title="Tab" tab_id=""][/vc_nested_tab]').'</div>';
    }
