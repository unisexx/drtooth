...
abstract class WPBakeryShortCode extends WPBakeryVisualComposerAbstract {
    ...
    public function getElementHolder($width) {
        ...
        $output .= '<div data-element_type="'.$this->settings["base"].'" class="wpb_'.$this->settings["base"].' wpb_content_element wpb_sortable '.wpb_translateColumnWidthToSpan($width,false).' '.$this->settings["class"].'">';
