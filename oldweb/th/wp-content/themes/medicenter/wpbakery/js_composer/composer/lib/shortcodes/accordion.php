...
function accordion_tab_id_settings_field($settings, $value) {
    $dependency = vc_generate_dependencies_attributes($settings);
    return '<div class="my_param_block">'
        .'<input name="'.$settings['param_name']
        .'" class="wpb_vc_param_value wpb-textinput '
...
add_shortcode_param('tab_id', 'accordion_tab_id_settings_field');
...
class WPBakeryShortCode_VC_Accordion extends WPBakeryShortCode {
    ...
    public function contentAdmin( $atts, $content ) {
        ...
        $tmp = '';
        $template = '<div class="wpb_template">'.do_shortcode('[vc_accordion_tab title="New Section" tab_id=""][/vc_accordion_tab]').'</div>';
