...
class WPBakeryShortCode_VC_Tab extends WPBakeryShortCode_VC_Column {
    ...
    public function containerHtmlBlockParams($width, $i) {
        return 'class="row-fluid wpb_column_container wpb_sortable_container wpb_'.$this->settings['base'].'_container wpb_container_block wpb_no_content_element_inside wpb_nested_tabs_inside wpb_nested_accordion_inside"';
    }
}
    ...
    public function content($atts, $content =null)
    {
        ...
        */
        ...
        $output .= "\n\t".'</div> '.$this->endBlockComment($width);*/
		 ...
		 $output .= '<div class="clearfix tabs'.$width.$el_class.($top_margin!="none" ? ' ' . $top_margin : '').'" data-interval="'.$interval.'">';
		 $output .= "\n\t\t\t".$tabs_nav;
		 $output .= "\n\t\t\t".wpb_js_remove_wpautop($content);
		 $output .= "\n\t\t".'</div>'.$this->endBlockComment('.wpb_wrapper').$this->endBlockComment($width);
