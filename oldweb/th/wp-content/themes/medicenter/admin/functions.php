...
function listitem_settings_field($settings, $value)
{
	$dependency = vc_generate_dependencies_attributes($settings);
	$value = explode(",", $value);
	$output = '<input type="button" value="' . __('Add list item', 'medicenter') . '" name="'.$settings['param_name'].'" class="button '.$settings['param_name'].' '.$settings['type'].'"' . $dependency . '/>';
	return $output;
}
//add item window
...
function listitemwindow_settings_field($settings, $value)
{
	...
	$output = '<div class="listitemwindow modal" name="'.$settings['param_name'].'">
		...
		<div class="modal-body wpb-edit-form" style="display: block;min-height: auto;">
			<div class="row-fluid wpb_el_type_dropdown">
			...
			<div class="row-fluid wpb_el_type_textfield">
			...
			<div class="row-fluid wpb_el_type_colorpicker">
				<div class="wpb_element_label">' . __("Custom text color", 'medicenter') . '</div>
				<div class="edit_form_line">
					<div class="color-group">
						<input name="item_content_color" class="wpb_vc_param_value wpb-textinput colorpicker_field" type="text" value=""/>
						<div class="vc-color-picker-block" style="display: none;top: -180px;"></div>
					</div>
				</div>
			</div>
			<div class="row-fluid wpb_el_type_colorpicker">
				...
				<div class="edit_form_line">
					<div class="color-group">
						<input name="item_value_color" class="wpb_vc_param_value wpb-textinput colorpicker_field" type="text" value=""/>
						<div class="vc-color-picker-block" style="display: none;"></div>
					</div>
				</div>
			</div>
			<div class="row-fluid wpb_el_type_colorpicker">
				...
				<div class="edit_form_line">
					<div class="color-group">
						<input name="item_border_color" class="wpb_vc_param_value wpb-textinput colorpicker_field" type="text" value=""/>
						<div class="vc-color-picker-block" style="display: none;"></div>
					</div>
					<span class="description clear">' . __('Set to <em>none</em> for no border', 'medicenter') . '</span>
				</div>
			</div>
			<div class="edit_form_actions">
				<a id="add-item-shortcode" class="button-primary" href="#">' . __("Add Item", 'medicenter') . '</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="cancel-item-options" href="#">' . __("Cancel", 'medicenter') . '</a>
			</div>
		</div>
	</div>';
	return $output;
