    ...
    $.wpbModal.prototype = {
        ...
        _initList:function () {
			...
			if (this.layout.$contentView.is('.wpb_vc_column_inner_container')) {
				$('.vc_not_inner_content_o'+(this.layout.$contentView.is(".wpb_nested_tabs_inside") ? ':not(.wpb_nested_tabs_o)':'')+(this.layout.$contentView.is(".wpb_nested_accordion_inside") ? ':not(.wpb_nested_accordion_o)':''), this.$view).hide();
               //$('.is_row_o', this.$view).show();
               //item_selector += ':not(.vc_not_inner_content_o)';
			   item_selector += ':not(.vc_not_inner_content_o'+(this.layout.$contentView.is(".wpb_nested_tabs_inside") ? ':not(.wpb_nested_tabs_o)':'')+(this.layout.$contentView.is(".wpb_nested_accordion_inside") ? ':not(.wpb_nested_accordion_o)':'')+')';
            } else if (this.layout.$contentView.is('.wpb_no_content_element_inside')) {
				$('.vc_not_inner_content_o:not(.is_row_o)'+(this.layout.$contentView.is(".wpb_nested_tabs_inside") ? ':not(.wpb_nested_tabs_o)':'')+(this.layout.$contentView.is(".wpb_nested_accordion_inside") ? ':not(.wpb_nested_accordion_o)':''), this.$view).hide();
				if(this.layout.$contentView.is(".wpb_nested_tabs_inside"))
					$('.wpb_nested_tabs_o', this.$view).show();
				if(this.layout.$contentView.is(".wpb_nested_accordion_inside"))
					$('.wpb_nested_accordion_o', this.$view).show();
				if(this.layout.$contentView.is(".wpb_vc_tab_container") || this.layout.$contentView.is(".wpb_vc_nested_tab_container") || this.layout.$contentView.is(".wpb_vc_accordion_tab_container") || this.layout.$contentView.is(".wpb_vc_nested_accordion_tab_container"))
					displayRow = true;
                item_selector += ':not(.vc_not_inner_content_o:not(.is_row_o)'+(this.layout.$contentView.is(".wpb_nested_tabs_inside") ? ':not(.wpb_nested_tabs_o)':'')+(this.layout.$contentView.is(".wpb_nested_accordion_inside") ? ':not(.wpb_nested_accordion_o)':'')+')';
            } else {
			...
			{
				$('.is_row_o', this.$view).hide();
				item_selector += ':not(.is_row_o)';
			}
