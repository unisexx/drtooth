...
wpb_map( array(
    ...
    "controls"	=> "full",
    "show_settings_on_create" => false,
    "class"		=> "wpb_nested_tabs vc_not_inner_content wpb_container_block",
	"icon"		=> "icon-wpb-ui-tab-content",
	"category"  => __('Content', 'js_composer'),
    "params"	=> array(
        /*array(
    ...
    "custom_markup" => '
	<div class="wpb_tabs_holder wpb_nested_tabs_holder wpb_holder">
		%content%
	</div>',
    'default_content' => '
        <ul class="tabs_controls nested_tabs_controls">
            <li><a href="#tab-'.$tab_id_1.'"><span>'.__('Tab 1', 'js_composer').'</span></a></li>
            <li><a href="#tab-'.$tab_id_2.'"><span>'.__('Tab 2', 'js_composer').'</span></a></li>
        </ul>
        [vc_nested_tab title="Tab 1" tab_id="'.$tab_id_1.'"][/vc_nested_tab]
        [vc_nested_tab title="Tab 2" tab_id="'.$tab_id_2.'"][/vc_nested_tab]
    ',
    'default_content_old' => '
	<ul>
		<li><a href="#tab-1"><span>'.__('Tab 1', 'js_composer').'</span></a></li>
    ...
    "js_callback" => array("init" => "wpbNestedTabsInitCallBack" /* , "shortcode" => "wpbTabsGenerateShortcodeCallBack" */)
    //"js_callback" => array("init" => "wpbTabsInitCallBack", "edit" => "wpbTabsEditCallBack", "save" => "wpbTabsSaveCallBack", "shortcode" => "wpbTabsGenerateShortcodeCallBack")
) );
...
//	"wrapper_class" => "clearfix",
	...
	',
    'default_content' => '
     [vc_accordion_tab title="Section 1" tab_id="'.$tab_id_1.'"][/vc_accordion_tab]
     [vc_accordion_tab title="Section 2" tab_id="'.$tab_id_2.'"][/vc_accordion_tab]
    ',
    'default_content_old' => '
	<div class="group">
...
wpb_map( array(
    ...
    "controls"	=> "full",
    "show_settings_on_create" => false,
    "class"		=> "wpb_nested_accordion vc_not_inner_content wpb_container_block",
	"icon"		=> "icon-wpb-ui-accordion",
	"category"  => __('Content', 'js_composer'),
//	"wrapper_class" => "clearfix",
    "params"	=> array(
	...
	<div class="wpb_accordion_holder wpb_nested_accordion_holder wpb_holder clearfix">
		%content%
	</div>
    <div class="tab_controls">
		<button class="add_tab" title="'.__("Add accordion section", "js_composer").'">'.__("Add accordion section", "js_composer").'</button>
	...
	',
    'default_content' => '
     [vc_nested_accordion_tab title="Section 1" tab_id="'.$tab_id_1.'"][/vc_nested_accordion_tab]
     [vc_nested_accordion_tab title="Section 2" tab_id="'.$tab_id_2.'"][/vc_nested_accordion_tab]
    ',
    'default_content_old' => '
	<div class="group">
		<h3><a href="#">'.__('Section 1', 'js_composer').'</a></h3>
    ...
    "js_callback" => array("init" => "wpbNestedAccordionInitCallBack", /* "shortcode" => "wpbAccordionGenerateShortcodeCallBack" */)
) );
...
if (is_plugin_active('LayerSlider/layerslider.php')) {
  ...
  wpb_map( array(
    "base"		=> "layerslider_vc",
    "name"		=> __("LayerSlider", "js_composer"),
    "class"		=> "",
    "icon"      => "icon-wpb-layerslider",
    "category"  => __('Content', 'js_composer'),
    //"admin_enqueue_css" => array(plugin_dir_url(__FILE__).'assets/styles.css'),
    "params"	=> array(
        array(
            "type" => "textfield",
            "heading" => __("Widget title", "js_composer"),
...
if ( shortcode_exists('rev_slider') ) { //is_plugin_active('revslider/revslider.php') || 
  global $wpdb;
  $rs = $wpdb->get_results( 
  	"
