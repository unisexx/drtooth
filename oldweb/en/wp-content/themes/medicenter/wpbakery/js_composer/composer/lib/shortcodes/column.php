...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
    ...
    public function content( $atts, $content = null ) {
        ...
        $output .= "\n\t".'<div class="'.$width.$el_class . ($top_margin!="none" ? ' ' . $top_margin : '') . '">';//class: wpb_content_element removed
    ...
    public function containerHtmlBlockParams($width, $i) {
        return 'class="row-fluid wpb_column_container wpb_sortable_container wpb_'.$this->settings['base'].'_container wpb_container_block wpb_nested_accordion_inside wpb_nested_tabs_inside"';
    }
}
