...
function vc_convert_shortcode($m) {
    ...
    } elseif( $tag == 'vc_tabs' || $tag == 'vc_nested_tabs' || $tag == 'vc_accordion' || $tag == 'vc_nested_accordion' || $tag == 'vc_tour') {
...
$vc_row_layouts = array(
    ...
    */
	...
	//array('cells' => '12_16_16_16', 'mask' => '424', 'title' => '1/2 + 1/6 + 1/6 + 1/6', 'icon_class' => 'l_12_16_16_16'),
	//array('cells' => '15_15_15_15_15', 'mask' => '530', 'title' => '1/5 + 1/5 + 1/5 + 1/5', 'icon_class' => 'l_15_15_15_15_15'),
